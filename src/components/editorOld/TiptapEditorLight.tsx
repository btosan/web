...
const TiptapEditorLight: React.FC<TiptapEditorProps> = ({
  content,
  onChange,
  editable = true,
...
// editor-content prose prose-invert max-w-none text-gray-50
  return (
    <div className="tiptap-editor-container-light">
      {editable && (
        <>
          <button
            type="button"
      ...
      <div className="editor-content-container" style={{ maxHeight: '400px', overflowY: 'auto' }}>
        <EditorContent
          editor={editor}
          className="editor-content bg-white prose max-w-none text-gray-900"
        />
      </div>
    </div>
  )
...
export default TiptapEditorLight