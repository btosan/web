  ...
  return (
    <>
      ...
      <button
        ...
        bg-size-[300%_300%] animate-gradient-wave hover:scale-[1.03] transition"
      >
        Start Your Project →
      </button>
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                {/* WhatsApp */}
                <a
                    href="https://wa.me/2348038168949?text=Hi%21%20I%27m%20interested%20in%20building%20a%20custom%20website%20or%20web%20application%20and%20would%20like%20to%20discuss%20my%20project."
                    target="_blank"
                ...
                <button
                  ...
                  border border-gray-700 text-gray-200 hover:border-purple-400 hover:text-white hover:cursor-pointer transition"
                >
                  <Mail />
                  Send an Email
                </button>
