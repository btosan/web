...
import { deletePackageCategory } from "@/lib/actions/packageCategories";
...
export default function DeletePackageCategoryButton({
  categoryId,
  categoryName,
  disabled = false,
}: Props) {
  ...
  const handleDelete = () => {
    ...
    startTransition(async () => {
      try {
        await deletePackageCategory(categoryId);
