        ...
        <div className="relative z-10 mx-auto grid w-full items-center gap-12 px-6 py-24 md:grid-cols-2 md:px-16 lg:gap-16 lg:px-12 xl:px-16 2xl:px-20 2xl:py-28">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-base leading-8 text-gray-200 md:text-lg xl:text-xl">
              Strategic branding, digital presence, and performance-driven
              marketing systems that attract the right audience and drive
            ...
            >
              ...
              <div>
                ...
                <p className="mt-5 max-w-md text-base leading-8 text-purple-100 md:text-lg">
                  Tell us about your goals and get a professional strategy
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-gray-300">
              Strategy-driven branding, marketing, and digital campaigns
              designed to grow your audience and business.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-gray-200">
              From branding strategy to paid campaigns, we drive visibility,
              leads, and growth.
            </p>
          </div>
