...
// === Services for Digital Branding & Marketing ===
...
// === Carousel for Digital Branding & Marketing ===
    ...
    <section className="relative overflow-hidden bg-black text-white">
      ...
      <div className="bg-gray-900 text-purple-50 py-24 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold">Our Digital Branding & Marketing Services</h2>
